            ...
            <div class="container-dash">
                <div class="content_head bg-light d-flex justify-content-between">
                    <div>
                        ...
                        <div class="d-inline-flex text-white  rounded-top pb-0 pt-2 px-3  ml-4 mt-4" style=" background-color:#012840; height:60px;">
                            <div class="d-flex mr-3" >
                                <div class=" px-2 py-3 h5"><i class=" fas  fa-calendar pr-2 border-right text-white" ></i></div>
                                    <div class=" px-2 py-3"><strong class="h5 font-weight-bold ">My calendar</strong></div>
                            </div>
                            <div>
                                <i class="fas fa-times-circle fa-sm"></i>
                            </div>
                ...
                <div class="content">
                    <div class="d-flex justify-content-end align-items-center py-2 px-4 m-4">
                        <span class="font-weight-bold mr-1"><i class="fas fa-home mr-1"></i>Home</span> / My Calendar
                    </div>

                <div class="step1 row mx-4 shadow">
                    <div class="col-md-12 bg-light mr-4 ">
                    <div class="d-flex justify-content-between m-2 ">
                            <h3 class="m-4" style="color:#0091CA;  font-size:15px;  font-weight: bold;"><i class="fas m-2 fa-calendar" style="color:#0091CA !important; font-size:20px;"></i>My Calendar</h3>
